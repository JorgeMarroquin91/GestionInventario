...
namespace GestionInventario.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            var compras = db.Compras.Include(c => c.Lote);
        ...
        public ActionResult Create([Bind(Include = "idCompra,cantidad,precioCompra,idLote")] Compras compras)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idCompra,cantidad,precioCompra,idLote")] Compras compras)
        {
            if (ModelState.IsValid)
            {

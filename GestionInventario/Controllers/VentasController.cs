...
namespace GestionInventario.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            var ventas = db.Ventas.Include(v => v.Descuento).Include(v => v.Lote);
        ...
        public ActionResult Create([Bind(Include = "idVenta,cantidad,precioVenta,idDescuento,idLote")] Ventas ventas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idVenta,cantidad,precioVenta,idDescuento,idLote")] Ventas ventas)
        {
            if (ModelState.IsValid)
            {
